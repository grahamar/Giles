...
RUN tar xzf /opt/giles_2.10-0.0.12.tgz -C /opt

EXPOSE 27017 1717

ENTRYPOINT /usr/bin/mongod --fork --syslog & /opt/giles-0.0.12/bin/giles -Dhttp.port=1717 -Dconfig.file=/opt/giles-0.0.12/conf/production.application.conf
